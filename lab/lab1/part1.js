...
console.log('All bread:', query4);

/* =====================
Use _.filter to return all baked goods that cost more than $4.
===================== */

var query5 = _.filter(bakedGoods, function(g){return g.price > 4.0});

console.log('More than $4:', query5);

/* =====================
Use _.sortBy to order the list by inventory (from lowest to highest). 
own note: sortby sorts in ascending order
===================== */

var query6 = _.sortBy(bakedGoods, function(g){return g.inventory});
...
var query7 = _.groupBy(bakedGoods, function(g){return g.type});
...
var printFood = function(key){
  console.log(key);
  values = Object
  key.forEach(value=>console.log(value.name + ' ... ' + value.price));
} 
var printMenu2 = function(object){
 keys=Object.keys(object);
 keys.forEach(function(key){printFood(key)});
}
