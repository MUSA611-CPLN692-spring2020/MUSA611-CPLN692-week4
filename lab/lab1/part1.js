...
===================== */
var query4 = _.filter(bakedGoods,
function(x) {
...
var query5 = _.filter(bakedGoods, function(arr){ return arr['price'] > 4;});
...
var query6 = _.sortBy(bakedGoods, function(arr){ return arr['inventory']; });
...
var query7 = _.groupBy(bakedGoods, function(arr){ return arr['type']; });
...
===================== */
function printMenu2(list){
  console.log("Cake");
  printMenu(list.Cake);
  console.log("Bread");
  printMenu(list.Bread);
}
printMenu2(query7);
//printMenu2(query7);
