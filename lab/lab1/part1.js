...
var query5 = _.filter(bakedGoods, function(bakegood){return bakegood.price > 4;});
...
var query6 = _.sortBy(bakedGoods, function(bakegood){return bakegood.inventory;});
...
var query7 = _.groupBy(bakedGoods, function(bakegood){return bakegood.type;});
...
var printMenu2 = function(query) {
  _.each(query, function(type, key){
    console.log(key);
