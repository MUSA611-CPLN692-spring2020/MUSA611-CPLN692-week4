...
var query4 = _.where(bakedGoods, {type: "Cake"}).concat(_.where(bakedGoods, {type: "Bread"}));
...
var query5 = _.filter(bakedGoods, function(item){
  return item.price > 4;
});
...
var query6 = _.sortBy(bakedGoods, function(item){
...
var query7 = _.groupBy(bakedGoods, function(item){
  return item.type;
});
